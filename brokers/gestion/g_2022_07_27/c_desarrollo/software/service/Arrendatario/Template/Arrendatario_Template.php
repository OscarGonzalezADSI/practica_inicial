<?php
function arrendatario_Template($arreglo)
{
?>
<!DOCTYPE html>
<html>
...
<script src="./js/tables/TableArrendatario/TableArrendatario.js"></script>
<script src="./js/view/view.js"></script>
<script>const arrendatarios = <?php echo json_encode($arreglo); ?>;</script>
<script src="./js/main/mainArrendatario.js"></script>
</head>
<body>
<div class="w3-top">

...
var cont = document.getElementById("opera")
    ...
    function funTexto(p,x,y){
        ...
        cadena =`<text x="86" y="70">Web Developer.</text>
                 <text x="86" y="131">Status: Available.</text>
                 <text x="86" y="184">Óscar González</text>
                 <text x="86" y="200">To.ADSI-SENA</text>
                 <text x="86" y="262">Developer junior</text>
                 <text x="86" y="311">FullStack-frontend</text>
                 <text x="86" y="330">Javascript-PHP-MySql</text>
                 <text x="86" y="391">Cúcuta-Colombia</text>
                 <text x="86" y="410">07-27-2021</text>`
